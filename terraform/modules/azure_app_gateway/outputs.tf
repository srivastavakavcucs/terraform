#-----------------------------------------------------------------------------------------
# Output details about the Azure Application Gateway that was provisioned.
#-----------------------------------------------------------------------------------------

output "application_gateway_name" {
  description = "The name of the Azure Application Gateway."
  value       = module.azure-app-gateway.application_gateway_name
}
...
output "application_gateway_id" {
  ...
  value       = module.azure-app-gateway.application_gateway_id
}
...
output "backend_address_pools" {
  ...
  value       = module.azure-app-gateway.backend_address_pools
}
...
output "backend_http_settings" {
  ...
  value       = module.azure-app-gateway.backend_http_settings
}
...
output "frontend_port" {
  ...
  value       = module.azure-app-gateway.frontend_port
}
...
output "request_routing_rules" {
  ...
  value       = module.azure-app-gateway.request_routing_rules
}

output "resource_id" {
  description = "Resource ID of Container Group Instance"
  value       = module.azure-app-gateway.resource_id
}
