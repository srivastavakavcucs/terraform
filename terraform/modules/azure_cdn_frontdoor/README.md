<!-- BEGIN_TF_DOCS -->
# Terraform Module: Azure CDN and Front Door Profile

[![Terraform](https://img.shields.io/badge/Terraform-Verified%20Module-blue.svg)](https://registry.terraform.io/modules/Azure/avm-res-cdn-profile/azurerm/latest)
[![Maintained by Microsoft](https://img.shields.io/badge/Maintained%20by-Microsoft-blue)](https://github.com/Azure/terraform-azurerm-avm-res-cdn-profile)

This Terraform module deploys an Azure CDN and Front Door (standard or premium) profile using the [Azure Verified Modules (AVM)](https://aka.ms/avm) standard.
...
## Table of Contents
- [Terraform Module: Azure CDN and Front Door Profile](#terraform-module-azure-cdn-and-front-door-profile)
  ...
  - [Additional Details on Complex Optional Inputs](#additional-details-on-complex-optional-inputs)
    - [`cdn_endpoint_custom_domains`](#cdn_endpoint_custom_domains)
      - [Example Input:](#example-input)
    - [`cdn_endpoints`](#cdn_endpoints)
      - [Example Input:](#example-input-1)
    - [`diagnostic_settings`](#diagnostic_settings)
      - [Example Input:](#example-input-2)
    - [`front_door_custom_domains`](#front_door_custom_domains)
      - [Example Input:](#example-input-3)
    - [`front_door_endpoints`](#front_door_endpoints)
      - [Example Input:](#example-input-4)
    - [`front_door_firewall_policies`](#front_door_firewall_policies)
      - [Example Input:](#example-input-5)
    - [`front_door_origin_groups`](#front_door_origin_groups)
      - [Example Input:](#example-input-6)
    - [`front_door_origins`](#front_door_origins)
      - [Example Input:](#example-input-7)
    - [`front_door_routes`](#front_door_routes)
      - [Example Input:](#example-input-8)
    - [`front_door_rule_sets`](#front_door_rule_sets)
    - [`front_door_rules`](#front_door_rules)
      - [Example Input:](#example-input-9)
    - [`front_door_secrets`](#front_door_secrets)
      - [Example Input:](#example-input-10)
    - [`front_door_security_policies`](#front_door_security_policies)
      - [Example Input:](#example-input-11)
    - [`lock`](#lock)
      - [Example Input:](#example-input-12)
    - [`managed_identities`](#managed_identities)
      - [Example Input:](#example-input-13)
    - [`response_timeout_seconds`](#response_timeout_seconds)
    - [`role_assignments`](#role_assignments)
      - [Example Input:](#example-input-14)
  - [Outputs](#outputs)
...
This module creates an Azure CDN and Front Door profile using the Azure Verified Module [`terraform-azurerm-avm-res-cdn-profile`](https://github.com/Azure/terraform-azurerm-avm-res-cdn-profile). The profile can be configured as standard or premium and allows diagnostic settings to be applied via the AVM diagnostics module.
...
module "cdn_front_door" {
  ...
  diagnostic_settings = {
    ...
    log_analytics_workspace_id = "/subscriptions/xxxx/resourceGroups/xxxx/providers/Microsoft.OperationalInsights/workspaces/xxxx"
    logs                       = []
    metrics                    = []
  }
}
...
|-----------------------|-------------------------------------------------|--------|
| `name`                | Name of the CDN Front Door profile              | string |
| `location`            | Azure region where the profile is created       | string |
| `resource_group_name` | Name of the resource group                      | string |
| `sku_name`            | SKU of the CDN profile                          | string |
...
| `cdn_endpoint_custom_domains` | Configuration object for CDN endpoint custom domains                     | any            | `{}`    |
| `cdn_endpoints`             | Configuration object for CDN endpoints                                      | any            | `{}`    |
| `diagnostic_settings`       | Configuration for diagnostics via AVM diagnostics module                    | any            | `null`  |
| `front_door_custom_domains` | Configuration for Front Door custom domains                                 | any            | `{}`    |
| `front_door_endpoints`      | Configuration for Front Door endpoints                                      | any            | `{}`    |
| `front_door_firewall_policies` | Configuration for Front Door WAF policies                              | any            | `{}`    |
| `front_door_origin_groups`  | Configuration for Front Door origin groups                                  | any            | `{}`    |
| `front_door_origins`        | Configuration for Front Door origins                                        | any            | `{}`    |
|`front_door_routes`          | Manages a map of Front Door (standard/premium) Routes. | map(object()) | `{}` |
| `front_door_rule_sets`      | Configuration for Front Door rule sets                                      | any            | `{}`    |
| `front_door_rules`          | Configuration for Front Door rules                                          | any            | `{}`    |
| `front_door_secrets` | Manages a map of Front Door (standard/premium) Secrets. | map(object()) | `{}` |
| `front_door_security_policies` | Configuration for Front Door security policies                          | any            | `{}`    |
|`lock` | Controls the Resource Lock configuration for this resource. | object | `null` |
| `managed_identities`                  | Configuration for system-assigned/user-assigned managed identity            | any            | `{}`    |
|`response_timeout_seconds` | Specifies the maximum response timeout in seconds. Possible values are between 16 and 240 seconds (inclusive). | number | `120` |
|`role_assignments` | A map of role assignments to create on the cdn/Front door profile. The map key is deliberately arbitrary to avoid issues where map keys maybe unknown at plan time. | map(object()) | `{}` |
...
| Name                            | Description                                                             |
|---------------------------------|-------------------------------------------------------------------------|
| `name`                          | The name of the Azure CDN Front Door instance                          |
| `resource_group_name`           | Resource group name where the Front Door is deployed                   |
| `resource_id`                   | The Azure resource ID of the CDN Front Door profile                    |
| `cdn_endpoint_custom_domains`   | Output object of CDN endpoint custom domains                           |
| `cdn_endpoints`                 | Output object of CDN endpoints                                         |
| `front_door_custom_domains`     | Output object of Front Door custom domains                             |
| `front_door_endpoints`          | Output object of Front Door endpoints                                  |
| `front_door_firewall_policies`  | Output object of Front Door firewall policies                          |
| `front_door_origin_groups`      | Output object of Front Door origin groups                              |
| `front_door_origins`            | Output object of Front Door origins                                    |
| `front_door_rule_sets`          | Output object of Front Door rule sets                                  |
| `front_door_rules`              | Output object of Front Door rules                                      |
| `front_door_security_policies`  | Output object of Front Door security policies                          |
| `resource`                      | Full output object of the deployed CDN Front Door profile              |
| `system_assigned_mi_principal_id` | Principal ID of the system-assigned managed identity (if enabled)   |
...
- **AVM CDN Profile Module GitHub**: [AVM CDN Profile Module GitHub](https://github.com/Azure/terraform-azurerm-avm-res-cdn-profile)
- **Terraform Registry - CDN Profile**: [Terraform Registry - CDN Profile](https://registry.terraform.io/modules/Azure/avm-res-cdn-profile/azurerm/latest)
- **Azure Front Door Documentation**: [Azure Front Door Documentation](https://learn.microsoft.com/en-us/azure/frontdoor/)
