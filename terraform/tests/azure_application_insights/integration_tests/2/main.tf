...
module "app_insights" {
  ...
  environment               = "dev"
  environment_number_suffix = "002"
  workspace_id              = module.azure-log-Analytics-workspace.resource_id
  ...
  # Dependency on azure log analytics workspace Module
  depends_on = [module.azure-log-Analytics-workspace]
}
